...
> **Archived narrative reference:** Route counts in this document describe the original freeze. `app/Config.php` is the runtime route authority; `docs/api/openapi.json` is a generated reference for the documented subset.
...
- `POST /api/v1/admin/content/{id}/lifecycle` (`admin.content.update`) — draft/schedule/publish/archive/restore
- `GET /api/v1/admin/content/{id}/preview` (`admin.panel.access`)
- `GET /api/v1/admin/content/{id}/revisions` (`admin.panel.access`)
...
- `DELETE /api/v1/admin/chapters/{id}` (`admin.content.update`, recent reauthentication)
- `POST /api/v1/admin/chapters/bulk` (`admin.content.update`)
- `GET|POST /api/v1/admin/series/{id}/team` (`admin.panel.access` / `admin.content.update`)
- `DELETE /api/v1/admin/series/team/{assignmentId}` (`admin.content.update`)
...
- `PUT /api/v1/admin/users/{id}` (`admin.users.manage`, recent reauthentication)
...
- `GET /api/v1/admin/rbac/matrix` (`admin.panel.access`)
- `POST /api/v1/admin/rbac/permissions/assign` (`admin.permissions.grant`, recent reauthentication)
- `DELETE /api/v1/admin/rbac/permissions` (`admin.permissions.revoke`, recent reauthentication)
...
- `DELETE /api/v1/admin/blogs/{id}` (`admin.blog.hide`, recent reauthentication)
- `GET /api/v1/admin/comments` (`admin.panel.access`)
- `DELETE /api/v1/admin/comments/{id}` (`admin.comment.delete`, recent reauthentication)
- `GET /api/v1/admin/uploads` (`admin.uploads.view`) — supports `q`, `mime`, `orphans`, `page`, `per_page`
- `DELETE /api/v1/admin/uploads/{id}` (`admin.uploads.delete`, recent reauthentication)
- `POST /api/v1/admin/uploads/bulk-delete` (`admin.uploads.delete`, recent reauthentication)
- `POST /api/v1/admin/uploads/{id}/optimize` (`admin.uploads.optimize`)
...
- `POST /api/v1/admin/wallets/{userId}/grant-package` (`admin.wallet.manage`, recent reauthentication)
- `POST /api/v1/admin/wallets/{userId}/credit` (`admin.wallet.manage`, recent reauthentication)
- `POST /api/v1/admin/wallets/{userId}/debit` (`admin.wallet.manage`, recent reauthentication)
...
- `POST /api/v1/admin/maintenance/backup` (`admin.jobs.run`, recent reauthentication)
...
- `POST /api/v1/admin/maintenance/api-tests` (`admin.jobs.run`)
- `POST /api/v1/admin/maintenance/openapi` (`admin.jobs.run`)
- `POST /api/v1/admin/maintenance/seed-data` (`admin.jobs.run`, recent reauthentication)
- `GET /api/v1/admin/maintenance/env` (`admin.settings.modify`; secrets are masked)
- `POST /api/v1/admin/maintenance/env` (`admin.settings.modify`, recent reauthentication; allowlisted keys only)
- `GET|POST /api/v1/admin/config/site` (`admin.settings.modify`)
- `GET|POST /api/v1/admin/webhooks` (`admin.settings.modify`)
- `PUT /api/v1/admin/webhooks/{id}` (`admin.settings.modify`)
- `DELETE /api/v1/admin/webhooks/{id}` (`admin.settings.modify`, recent reauthentication)
- `POST /api/v1/admin/webhooks/{id}/test` (`admin.settings.modify`)
...
- `GET /api/v1/admin/reports` (`admin.reports.view`)
- `GET /api/v1/admin/reports/{id}` (`admin.reports.view`)
- `PATCH|PUT /api/v1/admin/reports/{id}` (`admin.reports.manage`)
- `GET /api/v1/admin/finance/transactions` (`admin.finance.view`)
- `POST /api/v1/admin/finance/transactions/{id}/refund` (`admin.finance.refund`, recent reauthentication)
- `PUT /api/v1/admin/taxonomies/{id}` (`admin.content.update`)
- `DELETE /api/v1/admin/taxonomies/{id}` (`admin.content.update`, recent reauthentication)
- `POST /api/v1/admin/taxonomies/merge` (`admin.content.update`, recent reauthentication)
- `PUT /api/v1/admin/taxonomies/order` (`admin.content.update`)
- `POST /api/v1/admin/auth/reauth` (`admin.panel.access`) — opens a five-minute critical-action window
- `GET /api/v1/admin/analytics/monetization` (`admin.metrics.view`)
- `GET /api/v1/admin/analytics/search-insights` (`admin.metrics.view`)
- `GET /api/v1/admin/analytics/funnel/{id}` (`admin.metrics.view`)
...
- `GET /api/v1/admin/dashboard` (`admin.metrics.view`, alias)
