    ...
    build: {
      ...
      rollupOptions: {
        ...
        output: {
          ...
          entryFileNames: "assets/js/client/[name]-[hash].js",
          chunkFileNames: "assets/js/client/[name]-[hash].js",
          ...
          assetFileNames: (assetInfo) => {
            ...
            if (/\.(woff|woff2|eot|ttf|otf)$/i.test(name)) {
              return "assets/fonts/client/[name]-[hash][extname]";
            }
            ...
            if (/\.css$/i.test(name)) {
              return "assets/css/client/[name]-[hash][extname]";
            }
