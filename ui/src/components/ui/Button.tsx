...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    'inline-flex items-center justify-center whitespace-nowrap font-bold uppercase tracking-wider transition-all duration-150 focus:outline-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed select-none';

  const sizeStyles = {
    sm: 'px-3 py-1.5 text-[10px] rounded-lg gap-1.5',
    md: 'px-4 py-2 text-xs rounded-lg gap-2',
    lg: 'px-5 py-2.5 sm:px-6 sm:py-3 text-xs sm:text-sm rounded-xl gap-2',
  };
