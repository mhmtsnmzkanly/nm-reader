...
export const LatestBlogsSection: React.FC<LatestBlogsSectionProps> = ({ blogs }) => {
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-xl font-extrabold font-serif text-[var(--text-primary)] tracking-tight">
              {t('home.latestBlogsTitle')}
            </h2>
            <p className="text-xs text-[var(--text-secondary)]">{t('home.latestBlogsSubtitle')}</p>
          </div>
        </div>
      </div>
