 ...
 */
export function renderChapterListItem($h, { type, slug, chapter }) {
        ...
        <div class="item-inner">
          <div class="item-title-row">
            ...
            <div class="item-after">
              ${chapter.isLocked
                ? $h`<span class="badge color-orange">${escapeHtml(formatCoins(chapter.price))}</span>`
                : $h`<span class="badge color-green">Open</span>`}
            </div>
          </div>
