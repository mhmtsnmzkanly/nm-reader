/** Central panel state schema. Page modules only depend on this store contract. */
export function createPanelStore({
  createStore,
  context = globalThis.__NMR_CONTEXT || {},
} = {}) {
  if (typeof createStore !== "function") {
    throw new TypeError("createPanelStore requires createStore.");
  }
  const store = createStore({
    ...
    configLoadError: "",
    config: (() => {
      const initial = context?.site_config || {};
      return {
        site_name: "NM Reader",
