...
final class ChapterDto
{
    ...
    public function __construct(
        ...
        public readonly ?string $translatorNote = null,
    ...
    public static function fromArray(array $row): self
    {
        return new self(
            ...
            body: $row['body'] ?? null,
            pages: $row['pages'] ?? [],
            translatorNote: isset($row['translator_note']) && is_string($row['translator_note']) ? $row['translator_note'] : null,
    ...
    public function toArray(?string $baseUrl = null): array
    {
        $data = [
            ...
            'body' => $this->body,
            'pages' => $this->pages,
            'translator_note' => $this->translatorNote,
