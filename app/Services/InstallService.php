...
final class InstallService
{
    ...
    private const ENV_KEYS = [
        ...
        'RESEND_API_KEY', 'GOOGLE_ANALYTICS_ID', 'GOOGLE_SITE_VERIFICATION', 'BING_SITE_VERIFICATION', 'YANDEX_SITE_VERIFICATION', 'GOOGLE_RECAPTCHA_SITE_KEY',
    ...
    private function generateEnv(array $environment, string $rootId): string
    {
        ...
        $lines = [
            ...
            'GOOGLE_SITE_VERIFICATION=' . $value($environment['GOOGLE_SITE_VERIFICATION']),
            'BING_SITE_VERIFICATION=' . $value($environment['BING_SITE_VERIFICATION']),
            'YANDEX_SITE_VERIFICATION=' . $value($environment['YANDEX_SITE_VERIFICATION']),
