...
('genre', 'Action', 'action', '{"icon":"flame","color":"#ef4444"}'),
('genre', 'Adventure', 'adventure', '{"icon":"compass","color":"#f59e0b"}'),
('genre', 'Fantasy', 'fantasy', '{"icon":"sparkles","color":"#8b5cf6"}'),
('genre', 'Urban Fantasy', 'urban-fantasy', '{"icon":"building","color":"#6366f1"}'),
('genre', 'Sci-Fi', 'sci-fi', '{"icon":"atom","color":"#06b6d4"}'),
('genre', 'Cyberpunk', 'cyberpunk', '{"icon":"cpu","color":"#a855f7"}'),
('genre', 'Romance', 'romance', '{"icon":"heart","color":"#ec4899"}'),
('genre', 'Drama', 'drama', '{"icon":"drama","color":"#f97316"}'),
('genre', 'Comedy', 'comedy', '{"icon":"laugh","color":"#eab308"}'),
('genre', 'Slice of Life', 'slice-of-life', '{"icon":"leaf","color":"#22c55e"}'),
('genre', 'Mystery', 'mystery', '{"icon":"search","color":"#64748b"}'),
('genre', 'Thriller', 'thriller', '{"icon":"alarm","color":"#dc2626"}'),
('genre', 'Horror', 'horror', '{"icon":"skull","color":"#7f1d1d"}'),
('genre', 'Psychological', 'psychological', '{"icon":"brain","color":"#7c3aed"}'),
('genre', 'Supernatural', 'supernatural', '{"icon":"ghost","color":"#4f46e5"}'),
('genre', 'Historical', 'historical', '{"icon":"landmark","color":"#a16207"}'),
('genre', 'Martial Arts', 'martial-arts', '{"icon":"swords","color":"#b91c1c"}'),
('genre', 'Sports', 'sports', '{"icon":"trophy","color":"#16a34a"}'),
('genre', 'Mecha', 'mecha', '{"icon":"bot","color":"#475569"}'),
('genre', 'Military', 'military', '{"icon":"shield","color":"#4d7c0f"}'),
('genre', 'School', 'school', '{"icon":"graduation","color":"#2563eb"}'),
('genre', 'Ecchi', 'ecchi', '{"icon":"eye","color":"#db2777"}'),
('genre', 'Harem', 'harem', '{"icon":"users","color":"#d946ef"}'),
('genre', 'Reverse Harem', 'reverse-harem', '{"icon":"user-heart","color":"#c026d3"}'),
('genre', 'Josei', 'josei', '{"icon":"flower","color":"#be185d"}'),
('genre', 'Seinen', 'seinen', '{"icon":"badge","color":"#334155"}'),
('genre', 'Shounen', 'shounen', '{"icon":"zap","color":"#ea580c"}'),
('genre', 'Shoujo', 'shoujo', '{"icon":"flower","color":"#f472b6"}'),
...
CREATE TABLE `comments` (
  ...
  `body` text NOT NULL,
  `moderation_status` enum('pending','approved','hidden','deleted') NOT NULL DEFAULT 'approved',
  `upvote_count` int(11) DEFAULT 0,
  `downvote_count` int(11) DEFAULT 0,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `deleted_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_comments_target_status` (`target_type`,`target_id`,`moderation_status`,`created_at`),
  KEY `idx_comments_status` (`moderation_status`,`created_at`),
