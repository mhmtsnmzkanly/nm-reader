...
final class ApiTestSuite
{
    ...
    private function testAdminEndpoints(): void
    {
        ...
        $adminRoutes = [
            ...
            ['POST', '/api/v1/admin/uploads/cleanup', 'POST /api/v1/admin/uploads/cleanup'],
            ...
            ['GET', '/api/v1/admin/rbac/ownership', 'GET /api/v1/admin/rbac/ownership'],
            ...
            ['POST', '/api/v1/admin/upload-images', 'POST /api/v1/admin/upload-images'],
